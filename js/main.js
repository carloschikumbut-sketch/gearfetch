    ...
    const cartHTML = `
        ...
        <div id="cart-sidebar" class="fixed top-0 right-0 h-full w-[90%] md:w-[450px] bg-white z-[1000] transform translate-x-full transition-transform duration-500 flex flex-col shadow-2xl">
            <div class="p-4 border-b flex justify-between items-center bg-white">
                <h2 class="text-lg font-bold uppercase tracking-widest text-black">Your Bag</h2>
                <button onclick="closeCart()" class="p-2 hover:rotate-90 transition-transform duration-300">
                    <i class="fa-solid fa-xmark text-xl"></i>
                </button>
            </div>
            
            <div id="side-cart-items" class="flex-1 overflow-y-auto p-4 space-y-4"></div>
            
            <div id="side-cart-footer" class="p-4 border-t bg-white space-y-2">
                <div class="flex justify-between items-center px-1">
                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Subtotal</span>
                    <span id="side-subtotal" class="text-lg font-black tracking-tight text-black">$0.00</span>
                </div>
                
                <p class="text-[9px] text-center text-gray-400 font-bold uppercase tracking-widest px-2 leading-relaxed mb-2">
                    Delivery calculated at checkout.
                </p>
                
                <button onclick="window.location.href='checkout.html'" class="w-full bg-black text-white py-3 font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-red-600 transition-all active:scale-[0.98]">
